...
你可以用浏览器打开[小助手的最新版本发布页](https://github.com/TKkk-iOSer/WeChatPlugin-MacOS/releases/latest)，然后点击 _Source code (zip)_ 将安装包下载下来，目前小助手的最新版本是 v1.7.5，所以此时你的_下载文件夹_内会有一个 _WeChatPlugin-MacOS-1.7.5.zip_ 安装包。
...
如果你下载的安装包不在_下载文件夹_中，而且你不知道命令怎么写，那么你可以先将安装包移动到下载文件夹中，然后运行上面的命令。
